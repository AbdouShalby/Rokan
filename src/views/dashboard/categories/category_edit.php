        ...
        <div class="row d-flex justify-content-center">
            ...
            <form action="<?= URLROOT?>category_update" method="POST">
                ...
                <div class="mb-3 w-25 m-auto">
                    ...
                    <input type="text" class="form-control" id="WorkName" aria-describedby="text" name="category_name" value="<?= $category->Category_Name ?>" required>
                </div>
                ...
                <div class="mb-3 w-25 m-auto">
                    ...
                    <textarea class="category-description" name="category_description"><?= $category->Category_Description ?></textarea>
                </div>
                <div class="mb-3 w-25 m-auto">
                    ...
                    <select class="form-select" name="category_visibilty" aria-label="Default select example">
                        <option value="1" <?php if ($category->Category_Visibility == 1) { echo  'selected';}?> >Yes</option>
                        <option value="0" <?php if ($category->Category_Visibility == 0) { echo  'selected';}?>>No</option>
                    </select>
                </div>
