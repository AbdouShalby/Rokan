<?php
$page = 'OurWork';
$pageTitle = 'Our Work | Edit';
require_once APPROOT . '/src/views/dashboard/inc/header.php';
?>

    <div class="container-fluid edit-work">
        <div class="row d-flex justify-content-center">
            <h1 class="text-center fw-bold mt-5 mb-5">Edit Work</h1>
            ...
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3 w-25 m-auto">
                    <label for="WorkName" class="form-label">Category</label>
