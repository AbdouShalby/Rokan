<?php
$page = 'Finishing';
$pageTitle = 'Finishing Orders';
require_once APPROOT . '/src/views/dashboard/inc/header.php';
?>

<div class="container-fluid finishing-orders">
    <div class="row d-flex justify-content-center">
        <h1 class="text-center fw-bold mt-5 mb-5">Finishing Orders</h1>

        <div class="card p-1 me-3 mb-3 order my-bg-color" style="width: 30rem;">
            <div class="card-body">
                ...
                <h5 class="card-title mb-3">Package: <span class="client-data">Package One</span></h5>
                <h5 class="card-title mb-3">Price: <span class="client-data">$5</span></h5>
