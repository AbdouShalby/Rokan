        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                <div class="socialMedia">
                    <a class="header-youtube" href="<?= YOUTUBE_LINK ?>" target="_blank"><i class="fab fa-youtube"></i></a>
                    <a class="header-instagram" href="<?= INSTAGRAM_LINK ?>" target="_blank"><i class="fab fa-instagram"></i></a>
                    <a class="header-pinterest" href="<?= PINTEREST_LINK ?>" target="_blank"><i class="fab fa-pinterest-p"></i></a>
                    <a class="header-facebook" href="<?= FACEBOOK_LINK ?>" target="_blank"><i class="fab fa-facebook"></i></a>
                </div>
            </div>
        </div>
    </div>
